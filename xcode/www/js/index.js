...
$(document).on('deviceready', function(e){
    ...
    $('#contact .send-btn').on('click tap', function(e) {
        ...
        $.ajax({
            type: "POST",
            url: 'http://iasp.br/appios/ws/?function=Contact',
    ...
    // Loading news
    $.getJSON( "http://iasp.br/appios/ws/?function=GetLastsNoticiasByCategory&categoryId=2", function(data) {
...
function loadNews(newsId){
    var url = "http://iasp.br/appios/ws/?function=GetNoticia&newsId="+newsId;
